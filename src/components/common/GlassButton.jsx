...
export default function GlassButton({
  ...
  const palette = {
    primary: isDarkMode
      ...
      : "bg-light-primary/10 text-[#23213a] font-semibold hover:bg-lavender hover:text-white border-light-primary/20",
    outline: isDarkMode
      ? "bg-blackish-blue/30 text-light-gray border-gray-600/40 hover:border-lavender hover:text-white"
      : "bg-white/40 text-[#23213a] font-semibold border-light-primary/30 hover:border-light-primary hover:text-light-primary",
    subtle: isDarkMode
      ? "bg-white/5 text-light-gray border-transparent hover:bg-white/10"
      : "bg-white/60 text-[#23213a] font-semibold border-transparent hover:bg-white/70",
  };
