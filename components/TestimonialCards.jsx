...
export default function TestimonialCards() {
  return (
    <div className="flex flex-col items-center px-4 py-8 rounded-lg">
      ...
      {/* Flex Layout */}
      <div className="flex flex-wrap justify-evenly w-full mx-auto gap-8">
        {testimonialsData.map((d) => (
          <div
            key={d.id}
            className="flex flex-col items-center justify-between max-w-md w-[390px] h-auto rounded-lg bg-space/90 border border-rose shadow-md shadow-black p-8 transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-fadeIn"
          >
            {/* Rotating Quote Icon */}
